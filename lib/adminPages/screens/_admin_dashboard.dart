...
class CheckAdminDashboard extends StatefulWidget {
  const CheckAdminDashboard({super.key});

  @override
  State<CheckAdminDashboard> createState() => _CheckAdminDashboardState();
}

class _CheckAdminDashboardState extends State<CheckAdminDashboard>
