...
class DriverDetails extends StatefulWidget {
  ...
  const DriverDetails({super.key, required this.driverData});
...
class _DriverDetailsState extends State<DriverDetails> {
  ...
  Future getRents() async {
    ...
    var rentcollection = await FirebaseFirestore.instance
        ...
        .doc(widget.driverData.organisationId)
        .collection('rents')
        .where('driver_id', isEqualTo: widget.driverData.driverId)
        .where('start_time',
          ...
          children: [
            ...
            Column(
              children: [
                _textRow(
                    label: 'Mobile number',
                    value: widget.driverData.mobileNumber),
                _textRow(
                    label: 'Total Earnings',
                    value: widget.driverData.totalEarnings.toStringAsFixed(2)),
                _textRow(
                    label: 'Total cash collected',
                    value: widget.driverData.cashCollected.toStringAsFixed(2)),
                _textRow(
                    label: 'Total duties',
                    value: widget.driverData.totalShifts.toString()),
                _textRow(
                    label: 'Joined on',
                    value: DateFormat('dd-MM-yyyy').format(
                        DateTime.parse(widget.driverData.driverAddedOn))),
              ],
            )
          ],
        ),
  ...
  Widget tripCompletiontracking() {
    ...
    int targetTrips =
        widget.driverData.targetTrips * widget.driverData.weeklyShifts;
              ...
              itemBuilder: (context, index) {
                ...
                return ExpandablePanel(
                  ...
                  header: ListTile(
                    ...
                    subtitle: Text(
                      widget.driverData.onRent.isNotEmpty
                          ? 'On going'
