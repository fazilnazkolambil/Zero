    ...
    Future.delayed(const Duration(seconds: 5), () {
      return Get.dialog(
        AlertDialog(
          ...
          content: const Text('Have you completed the payment?'),
          actions: [
            TextButton(
              onPressed: () {
                Get.back();
                Get.back();
                Fluttertoast.showToast(
                    msg: 'Payment cancelled', backgroundColor: Colors.red);
              },
              child: const Text('No'),
            ),
            TextButton(
